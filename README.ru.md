...
- Отображение всех изменений пульса отдельными точками и текущего значения при единственной точке Recorder
...
единственном значении остаётся пунктирная линия с числовой меткой.
