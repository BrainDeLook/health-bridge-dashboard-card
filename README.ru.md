...
При первом запуске открыт график активности, а график пульса закрыт. Нажатие на
заголовок переключает разделы: открытие активности закрывает пульс, а открытие
пульса закрывает активность. Один из этих графиков всегда остаётся открытым.
Последний выбор запоминается отдельно для каждого найденного профиля.
